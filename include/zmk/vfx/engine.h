...
extern const struct vfx_layer_api vfx_layer_hold_api;
extern const struct vfx_layer_api vfx_layer_dart_api;
extern const struct vfx_layer_api vfx_layer_static_api;
